...
const ProductTable = () => {
            ...
            <ul className={cn('container__list')}>
                <li>
                    <div className={cn('big-gap')}>
                        ...
                        <p className={cn('container__input', 'title')}>Bread Hercules grain</p>
                    </div>
                    <div className={cn('big-gap')}>
                        <h3 className={cn('container__label')}>Category</h3>
                        <p className={cn('container__input', 'category')}>Flour</p>
                    </div>
                    <div className={cn('big-gap')}>
                    ...
                    <div className={cn('small-gap')}>
                        ...
                        <p className={cn('container__input__small', 'red')}>No</p>
                        </div>
                        <span ><Icon
                        iconId="icon-trash"
                        w={20}
    ...
    <li>
                    ...
                    <div className={cn('small-gap')}>
                        <h3 className={cn('container__label')}>Recommend</h3>
                        <p className={cn('container__input__small', 'green')}>Yes</p>
                        </div>
                        <span ><Icon
                        iconId="icon-trash"
                        w={20}
