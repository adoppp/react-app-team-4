            ...
            <ul className={cn('container__list')}>
                <li>
                    ...
                    <div className={cn('big-gap')}>
                        ...
                        <p className={cn('container__input', 'category')}>Body weight</p>
                    </div>
                     <div className={cn('big-gap')}>
                        <h3 className={cn('container__label')}>Name</h3>
                        <p className={cn('container__input', 'name')}>3/4 sit-up</p>
                    </div>
                    <div className={cn('big-gap')}>
                        <h3 className={cn('container__label')}>Target</h3>
                        <p className={cn('container__input__small', 'target')}>Abs</p>
                    </div>
                    <div className={cn('big-gap')}>
                        <h3 className={cn('container__label')}>Burned Calories</h3>
                        <p className={cn('container__input__small', 'burned')}>100</p>
                    </div>
                    <div className={cn('small-gap')}>
                        <h3 className={cn('container__label')}>Time</h3>
                        <p className={cn('container__input__small', 'time')}>60</p>
                        </div>
                        <span ><Icon
                        iconId="icon-trash"
                        w={20}
